          ...
          <div className="card-inner">
            ...
            >
              <div className="card-top">
                ...
                <div className="card-bottom">
                  <p>
                    Check out our best practices and support to quickly make
                    text messaging one of your top 3 revenue channels.
                  </p>
                </div>
              </div>
            </motion.section>
            ...
            >
              <div className="card-top">
                ...
                <div className="card-bottom">
                  <p>
                    You own your data, store design and business plan, but you
                    are free to use the software platform and resources provided
                    by Shopify.
                  </p>
                </div>
              </div>
              ...
              <div className="card-top">
                ...
                <div className="card-bottom">
                  <p>
                    ...
                    it sends you free updates for a lifetime without charging
                    you anything.
                  </p>
                </div>
              </div>
              ...
              <div className="card-top">
                ...
                <div className="card-bottom">
                  <p>
                    ...
                    their order status, browse your store and create an account
                    on the spot.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="card-top">
                ...
                <div className="card-bottom">
                  <p>
                    You can have peace of mind knowing that your system is
                    running smoothly thanks to our techs' expertise and
                    precision.
                  </p>
                </div>
              </div>
